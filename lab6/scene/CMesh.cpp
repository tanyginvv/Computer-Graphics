...
// todo: При изучении структуры 3ds-файла мы узнали, что каждая грань сетки хранит индекс используемого ею материала. 
// Однако в нашей модели сейчас пока это не предусмотрено. Данная задача будет оставлена на самостоятельную реализацию.
